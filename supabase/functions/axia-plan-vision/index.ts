...
- COMPARTIMENTOS: NÃO preencher estimated_area com estimativas típicas por tipologia quando NÃO houver escala ou cotas. Comportamento obrigatório:
  ...
  • Sem escala/cotas mas COM rótulos/contornos visíveis → DEVES devolver o compartimento na lista rooms[] com bbox aproximado e tipo_normalizado. estimated_area pode usar estimativa por tipologia (intervalos do ponto 4), evidencias "[estimado por tipologia]", confidence <= 0.45, review_required=true. NUNCA omitir o compartimento só porque falta escala.
  • Tipologia clara → preencher rooms[]. O utilizador valida na UI; faltar escala não é motivo para devolver lista vazia.
