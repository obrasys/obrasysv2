      ...
      <div className="p-4 md:p-6 space-y-4 md:space-y-6">
        ...
        <div className="flex items-center gap-3 md:gap-4">
          ...
          <div className="min-w-0">
            <h1 className="text-xl md:text-2xl font-bold tracking-tight">Editar Cliente</h1>
            <p className="text-sm md:text-base text-muted-foreground truncate">{cliente.nome}</p>
          </div>
        </div>
