    ...
    mutationFn: async (formData: PackageFormData) => {
      ...
      const { data: pkg, error } = await supabase
        ...
        .insert({
          ...
          has_bomba_calor: formData.has_bomba_calor,
          has_termoacumulador: formData.has_termoacumulador,
          has_piso_radiante: formData.has_piso_radiante,
          has_paineis_solares: formData.has_paineis_solares,
          equipamentos_extra: formData.equipamentos_extra,
