...
/**
 * Conteúdo completo da página de Perfil (sem AppLayout/PageHeader).
 * Reutilizado em /perfil (legacy) e /definicoes/perfil (novo shell).
 */
export function PerfilContent() {
  ...
  return (
    <div className="space-y-4 md:space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4">
            <div className="relative group">
              <div
                ...
                style={{
                  background:
                    completionPercent === 100 ? '#7de578' : 'hsl(var(--muted))',
                }}
              >
        ...
        {[
          {
            icon: Calendar,
            label: 'Membro desde',
            value: format(new Date(profile.trial_start), 'MMM yyyy', { locale: pt }),
          },
        ...
        <TabsContent value="empresa">
              ...
              {companyHasData ? (
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    {[
                      ...
                      },
                      {
                        icon: Mail,
                        label: 'Email',
                        value: profile.empresa_email || 'Não definido',
                      },
                      {
                        icon: Phone,
                        label: 'Telefone',
                        value: profile.empresa_telefone || 'Não definido',
                      },
                      {
                        icon: MapPin,
                        label: 'País',
                        value: profile.empresa_pais || 'Portugal',
                      },
                    ].map((item) => (
                      <div
                        key={item.label}
                ...
                <div className="text-center py-10">
                  ...
                  <h3 className="font-semibold text-foreground mb-1">
                    Dados da empresa por preencher
                  </h3>
                  <p className="text-sm text-muted-foreground mb-5 max-w-sm mx-auto">
                    Preencha os dados da sua empresa para que apareçam nos seus orçamentos e
          ...
          <Card className="mt-4">
            <CardContent className="pt-6 space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Estas observações aparecem no rodapé do PDF de todos os orçamentos. Uma
                observação por linha. Pode ser substituído individualmente em cada
                orçamento (Editar → Apresentação ao Cliente → Observações do rodapé).
              </p>
              <Textarea
                value={observations}
      ...
      <EmpresaModal open={empresaModalOpen} onOpenChange={setEmpresaModalOpen} />
      <UpgradePromptModal
