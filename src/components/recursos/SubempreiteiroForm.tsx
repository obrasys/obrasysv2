...
export function SubempreiteiroForm({
  open,
  onOpenChange,
  subempreiteiro,
  onSubmit,
  isLoading,
}: SubempreiteiroFormProps) {
          ...
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Nome do subempreiteiro" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <div className="flex justify-end gap-2 pt-4">
              ...
              <Button type="submit" disabled={isLoading}>
                {isLoading ? 'A guardar...' : subempreiteiro ? 'Atualizar' : 'Criar'}
              </Button>
            </div>
          </form>
        </Form>
