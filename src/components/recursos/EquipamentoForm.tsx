          ...
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
                  ...
                  <FormItem>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        {CATEGORIA_EQUIPAMENTO_OPTIONS.map((cat) => (
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <Select value={field.value} onValueChange={field.onChange}>
                      ...
                      <SelectContent>
                        {Object.entries(ESTADO_EQUIPAMENTO_CONFIG).map(([key, config]) => (
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Valor Aquisição (€)</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                        step="0.01"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Local atual" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Obra Associada</FormLabel>
                    <Select
                      value={field.value || 'none'}
                      onValueChange={(val) => field.onChange(val === 'none' ? '' : val)}
                    >
            ...
            <div className="flex justify-end gap-2 pt-4">
              ...
              <Button type="submit" disabled={isLoading}>
                {isLoading ? 'A guardar...' : equipamento ? 'Atualizar' : 'Criar'}
              </Button>
            </div>
          </form>
        </Form>
