...
import { CheckCircle2, AlertTriangle, ChevronRight, Clock, FileText, ClipboardList } from 'lucide-react';
...
export function DashboardPriorities({ obras, tarefasPendentes, rdosPendentes, medicoesPendentes }: DashboardPrioritiesProps) {
  ...
  // Build priority items from real data
  ...
  if (alerts.length === 0) alerts.push({ label: 'Sem alertas no momento', severity: 'low' });
